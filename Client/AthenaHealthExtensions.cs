...
namespace AndriiKurdiumov.AuthenaHealth.Client
{
    ...
    public static partial class AthenaHealthExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<AppointmentInformationList> GetBookedAppointmentsFromMultipleDepartmentsAsync(this IAthenaHealth operations, string appointmentstatus = default(string), int? appointmenttypeid = default(int?), string departmentid = default(string), string enddate = default(string), string endlastmodified = default(string), bool? ignorerestrictions = default(bool?), int? patientid = default(int?), string providerid = default(string), string scheduledenddate = default(string), string scheduledstartdate = default(string), bool? showcancelled = default(bool?), bool? showclaimdetail = default(bool?), bool? showcopay = default(bool?), bool? showexpectedprocedurecodes = default(bool?), bool? showinsurance = default(bool?), bool? showpatientdetail = default(bool?), bool? showremindercalldetail = default(bool?), string startdate = default(string), string startlastmodified = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetBookedAppointmentsFromMultipleDepartmentsWithHttpMessagesAsync(appointmentstatus, appointmenttypeid, departmentid, enddate, endlastmodified, ignorerestrictions, patientid, providerid, scheduledenddate, scheduledstartdate, showcancelled, showclaimdetail, showcopay, showexpectedprocedurecodes, showinsurance, showpatientdetail, showremindercalldetail, startdate, startlastmodified, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
