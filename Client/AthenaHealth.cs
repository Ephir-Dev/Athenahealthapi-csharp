...
namespace AndriiKurdiumov.AuthenaHealth.Client
{
    ...
    public partial class AthenaHealth : ServiceClient<AthenaHealth>, IAthenaHealth
    {
        ...
        /// </return>
        public async Task<HttpOperationResponse<PracticesInformation>> GetPracticeInfoWithHttpMessagesAsync(int? limit = default(int?), int? offset = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (limit > 5000)
            {
            ...
            // Create Result
            var _result = new HttpOperationResponse<PracticesInformation>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<PracticesInformation>(_responseContent, DeserializationSettings);
                }
