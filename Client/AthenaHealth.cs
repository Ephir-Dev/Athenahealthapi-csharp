...
namespace AndriiKurdiumov.AuthenaHealth.Client
{
    ...
    public partial class AthenaHealth : ServiceClient<AthenaHealth>, IAthenaHealth
    {
        ...
        public AthenaHealth(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// </param>
        public AthenaHealth(params DelegatingHandler[] handlers) : base(handlers)
        {
            Initialize();
        }
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public AthenaHealth(HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : base(rootHandler, handlers)
        {
            Initialize();
        }
        ...
        /// </exception>
        public AthenaHealth(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public AthenaHealth(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<PatientLabResultDocumentList>> GetPatientLabResultDocumentsWithHttpMessagesAsync(int patientId, int? departmentid = default(int?), string documentsubclass = default(string), int? encounterid = default(int?), bool? showdeleted = default(bool?), bool? showtemplate = default(bool?), string status = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Apivariant == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Apivariant");
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("patientId", patientId);
                tracingParameters.Add("departmentid", departmentid);
                tracingParameters.Add("documentsubclass", documentsubclass);
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{apivariant}/{practiceid}/patients/{patientId}/documents/labresult").ToString();
            _url = _url.Replace("{practiceid}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(Practiceid, SerializationSettings).Trim('"')));
            _url = _url.Replace("{apivariant}", System.Uri.EscapeDataString(Apivariant));
            _url = _url.Replace("{patientId}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(patientId, SerializationSettings).Trim('"')));
            List<string> _queryParameters = new List<string>();
            ...
            if (documentsubclass != null)
            {
                _queryParameters.Add(string.Format("documentsubclass={0}", System.Uri.EscapeDataString(documentsubclass)));
            }
            if (encounterid != null)
            {
                _queryParameters.Add(string.Format("encounterid={0}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(encounterid, SerializationSettings).Trim('"'))));
            }
            if (showdeleted != null)
            {
                _queryParameters.Add(string.Format("showdeleted={0}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(showdeleted, SerializationSettings).Trim('"'))));
            }
            ...
            // Create Result
            var _result = new HttpOperationResponse<PatientLabResultDocumentList>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<PatientLabResultDocumentList>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        public async Task<HttpOperationResponse<object>> CreatePatientLabResultDocumentWithHttpMessagesAsync(int patientId, string accessionid = default(string), string analytes = default(string), string attachmentcontents = default(string), string attachmenttype = default(string), string autoclose = default(string), int? departmentid = default(int?), int? documenttypeid = default(int?), int? facilityid = default(int?), string internalnote = default(string), string interpretation = default(string), string observationdate = default(string), string observationtime = default(string), string priority = default(string), int? providerid = default(int?), string reportstatus = default(string), string resultstatus = default(string), string specimenreceiveddatetime = default(string), string specimenreporteddatetime = default(string), int? tietoorderid = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                _invocationId = ServiceClientTracing.NextInvocationId.ToString();
                Dictionary<string, object> tracingParameters = new Dictionary<string, object>();
                tracingParameters.Add("accessionid", accessionid);
                tracingParameters.Add("analytes", analytes);
                tracingParameters.Add("attachmentcontents", attachmentcontents);
                tracingParameters.Add("attachmenttype", attachmenttype);
                tracingParameters.Add("autoclose", autoclose);
                tracingParameters.Add("departmentid", departmentid);
                tracingParameters.Add("documenttypeid", documenttypeid);
                tracingParameters.Add("facilityid", facilityid);
                tracingParameters.Add("internalnote", internalnote);
                tracingParameters.Add("interpretation", interpretation);
                tracingParameters.Add("observationdate", observationdate);
                tracingParameters.Add("observationtime", observationtime);
                tracingParameters.Add("priority", priority);
                tracingParameters.Add("providerid", providerid);
                tracingParameters.Add("reportstatus", reportstatus);
                tracingParameters.Add("resultstatus", resultstatus);
                tracingParameters.Add("specimenreceiveddatetime", specimenreceiveddatetime);
            ...
            if(accessionid != null)
            {
                values.Add(new KeyValuePair<string,string>("accessionid", accessionid));
            }
            if(analytes != null)
            {
                values.Add(new KeyValuePair<string,string>("analytes", analytes));
            }
            if(attachmentcontents != null)
            {
                values.Add(new KeyValuePair<string,string>("attachmentcontents", attachmentcontents));
            }
            if(attachmenttype != null)
            {
                values.Add(new KeyValuePair<string,string>("attachmenttype", attachmenttype));
            }
            if(autoclose != null)
            {
                values.Add(new KeyValuePair<string,string>("autoclose", autoclose));
            }
            if(departmentid != null)
            {
                values.Add(new KeyValuePair<string,string>("departmentid", departmentid?.ToString()));
            ...
            {
                values.Add(new KeyValuePair<string,string>("documenttypeid", documenttypeid?.ToString()));
            }
            if(facilityid != null)
            {
                values.Add(new KeyValuePair<string,string>("facilityid", facilityid?.ToString()));
            }
            if(internalnote != null)
            {
                values.Add(new KeyValuePair<string,string>("internalnote", internalnote));
            }
            if(interpretation != null)
            {
                values.Add(new KeyValuePair<string,string>("interpretation", interpretation));
            }
            if(observationdate != null)
            {
                values.Add(new KeyValuePair<string,string>("observationdate", observationdate));
            }
            if(observationtime != null)
            {
                values.Add(new KeyValuePair<string,string>("observationtime", observationtime));
            }
            if(priority != null)
            {
                values.Add(new KeyValuePair<string,string>("priority", priority));
            }
            if(providerid != null)
            {
            ...
            {
                values.Add(new KeyValuePair<string,string>("reportstatus", reportstatus));
            }
            if(resultstatus != null)
            {
                values.Add(new KeyValuePair<string,string>("resultstatus", resultstatus));
            }
            if(specimenreceiveddatetime != null)
            {
                values.Add(new KeyValuePair<string,string>("specimenreceiveddatetime", specimenreceiveddatetime));
            }
            if(specimenreporteddatetime != null)
            {
                values.Add(new KeyValuePair<string,string>("specimenreporteddatetime", specimenreporteddatetime));
            }
            if(tietoorderid != null)
            {
                values.Add(new KeyValuePair<string,string>("tietoorderid", tietoorderid?.ToString()));
            }
            var _formContent = new FormUrlEncodedContent(values);
            _httpRequest.Content = _formContent;
            // Send Request
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<CreateLabResultDocumentResponse>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<IList<PatientLabResultDocumentDetails>>> GetPatientLabResultDocumentWithHttpMessagesAsync(int patientId, int labResultId, bool? showtemplate = default(bool?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Apivariant == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Apivariant");
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{apivariant}/{practiceid}/patients/{patientId}/documents/labresult/{labResultId}").ToString();
            _url = _url.Replace("{practiceid}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(Practiceid, SerializationSettings).Trim('"')));
            _url = _url.Replace("{apivariant}", System.Uri.EscapeDataString(Apivariant));
            _url = _url.Replace("{patientId}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(patientId, SerializationSettings).Trim('"')));
            ...
            // Create Result
            var _result = new HttpOperationResponse<IList<PatientLabResultDocumentDetails>>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<IList<PatientLabResultDocumentDetails>>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<DeleteLabResultDocumentResponse>> DeleteePatientLabResultDocumentWithHttpMessagesAsync(int patientId, int labResultId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Apivariant == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Apivariant");
            ...
            // Create Result
            var _result = new HttpOperationResponse<DeleteLabResultDocumentResponse>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<DeleteLabResultDocumentResponse>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<IList<ProviderInformation>>> GetProviderByIdWithHttpMessagesAsync(int providerId, bool? showallproviderids = default(bool?), int? showfederalidnumber = default(int?), double? showusualdepartmentguessthreshold = default(double?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Apivariant == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Apivariant");
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{apivariant}/{practiceid}/providers/{providerId}").ToString();
            _url = _url.Replace("{practiceid}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(Practiceid, SerializationSettings).Trim('"')));
            _url = _url.Replace("{apivariant}", System.Uri.EscapeDataString(Apivariant));
            _url = _url.Replace("{providerId}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(providerId, SerializationSettings).Trim('"')));
            List<string> _queryParameters = new List<string>();
            if (showallproviderids != null)
            {
                _queryParameters.Add(string.Format("showallproviderids={0}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(showallproviderids, SerializationSettings).Trim('"'))));
            }
            if (showfederalidnumber != null)
            {
                _queryParameters.Add(string.Format("showfederalidnumber={0}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(showfederalidnumber, SerializationSettings).Trim('"'))));
            }
            if (showusualdepartmentguessthreshold != null)
            {
                _queryParameters.Add(string.Format("showusualdepartmentguessthreshold={0}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(showusualdepartmentguessthreshold, SerializationSettings).Trim('"'))));
            ...
            // Create Result
            var _result = new HttpOperationResponse<IList<ProviderInformation>>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<IList<ProviderInformation>>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// </param>
        /// <param name='departmentid'>
        /// The athenaNet department ID. Multiple IDs (either as a comma delimited list
        /// or multiple POSTed values) are allowed.
        /// </param>
        /// <param name='enddate'>
        /// End of the appointment search date range (mm/dd/yyyy). Inclusive.
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<AppointmentInformationList>> GetBookedAppointmentsFromMultipleDepartmentsWithHttpMessagesAsync(string appointmentstatus = default(string), int? appointmenttypeid = default(int?), string departmentid = default(string), string enddate = default(string), string endlastmodified = default(string), bool? ignorerestrictions = default(bool?), int? patientid = default(int?), string providerid = default(string), string scheduledenddate = default(string), string scheduledstartdate = default(string), bool? showcancelled = default(bool?), bool? showclaimdetail = default(bool?), bool? showcopay = default(bool?), bool? showexpectedprocedurecodes = default(bool?), bool? showinsurance = default(bool?), bool? showpatientdetail = default(bool?), bool? showremindercalldetail = default(bool?), string startdate = default(string), string startlastmodified = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Apivariant == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Apivariant");
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{apivariant}/{practiceid}/appointments/booked/multipledepartment").ToString();
            _url = _url.Replace("{practiceid}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(Practiceid, SerializationSettings).Trim('"')));
            _url = _url.Replace("{apivariant}", System.Uri.EscapeDataString(Apivariant));
            List<string> _queryParameters = new List<string>();
            if (appointmentstatus != null)
            ...
            if (departmentid != null)
            {
                _queryParameters.Add(string.Format("departmentid={0}", System.Uri.EscapeDataString(departmentid)));
            }
            if (enddate != null)
            {
                _queryParameters.Add(string.Format("enddate={0}", System.Uri.EscapeDataString(enddate)));
        ...
        public async Task<HttpOperationResponse<LabResultList>> GetPatientLabResultsWithHttpMessagesAsync(int patientId, int departmentid, int? allresultsbyencounterid = default(int?), string analyteresultstatus = default(string), string enddate = default(string), string labresultstatus = default(string), bool? showabnormaldetails = default(bool?), bool? showhidden = default(bool?), bool? showtemplate = default(bool?), string startdate = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{apivariant}/{practiceid}/chart/{patientId}/labresults").ToString();
            _url = _url.Replace("{practiceid}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(Practiceid, SerializationSettings).Trim('"')));
            _url = _url.Replace("{apivariant}", System.Uri.EscapeDataString(Apivariant));
            _url = _url.Replace("{patientId}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(patientId, SerializationSettings).Trim('"')));
            List<string> _queryParameters = new List<string>();
        ...
        public async Task<HttpOperationResponse<VitalsList>> GetPatientVitalsWithHttpMessagesAsync(int patientId, int departmentid, string enddate = default(string), bool? showemptyvitals = default(bool?), string startdate = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{apivariant}/{practiceid}/chart/{patientId}/vitals").ToString();
            _url = _url.Replace("{practiceid}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(Practiceid, SerializationSettings).Trim('"')));
            _url = _url.Replace("{apivariant}", System.Uri.EscapeDataString(Apivariant));
            _url = _url.Replace("{patientId}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(patientId, SerializationSettings).Trim('"')));
            List<string> _queryParameters = new List<string>();
            ...
            if (showemptyvitals != null)
            {
                _queryParameters.Add(string.Format("showemptyvitals={0}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(showemptyvitals, SerializationSettings).Trim('"'))));
            }
            if (startdate != null)
            {
                _queryParameters.Add(string.Format("startdate={0}", System.Uri.EscapeDataString(startdate)));
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<ProblemsList>> GetPatientProblemsWithHttpMessagesAsync(int patientId, int departmentid, bool? showdiagnosisinfo = default(bool?), bool? showinactive = default(bool?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Apivariant == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Apivariant");
            ...
            List<string> _queryParameters = new List<string>();
            _queryParameters.Add(string.Format("departmentid={0}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(departmentid, SerializationSettings).Trim('"'))));
            if (showdiagnosisinfo != null)
            {
                _queryParameters.Add(string.Format("showdiagnosisinfo={0}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(showdiagnosisinfo, SerializationSettings).Trim('"'))));
            }
            ...
            // Create Result
            var _result = new HttpOperationResponse<ProblemsList>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
        ...
        public async Task<HttpOperationResponse<SocialHistoryList>> GetPatientSocialHistoryWithHttpMessagesAsync(int patientId, int departmentid, string recipientcategory = default(string), bool? shownotperformedquestions = default(bool?), bool? showunansweredquestions = default(bool?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{apivariant}/{practiceid}/chart/{patientId}/socialhistory").ToString();
            _url = _url.Replace("{practiceid}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(Practiceid, SerializationSettings).Trim('"')));
            _url = _url.Replace("{apivariant}", System.Uri.EscapeDataString(Apivariant));
            _url = _url.Replace("{patientId}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(patientId, SerializationSettings).Trim('"')));
            List<string> _queryParameters = new List<string>();
            ...
            {
                _queryParameters.Add(string.Format("recipientcategory={0}", System.Uri.EscapeDataString(recipientcategory)));
            }
            if (shownotperformedquestions != null)
            {
                _queryParameters.Add(string.Format("shownotperformedquestions={0}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(shownotperformedquestions, SerializationSettings).Trim('"'))));
            }
            ...
            // Create Result
            var _result = new HttpOperationResponse<SocialHistoryList>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<SocialHistoryList>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<ProceduresList>> GetPatientSurgicalHistoryWithHttpMessagesAsync(int patientId, int departmentid, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Apivariant == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Apivariant");
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{apivariant}/{practiceid}/chart/{patientId}/surgicalhistory").ToString();
            _url = _url.Replace("{practiceid}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(Practiceid, SerializationSettings).Trim('"')));
            _url = _url.Replace("{apivariant}", System.Uri.EscapeDataString(Apivariant));
            _url = _url.Replace("{patientId}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(patientId, SerializationSettings).Trim('"')));
            List<string> _queryParameters = new List<string>();
            ...
            // Create Result
            var _result = new HttpOperationResponse<ProceduresList>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<ProceduresList>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        public async Task<HttpOperationResponse<IList<EncountersList>>> GetPatientEncountersWithHttpMessagesAsync(int patientId, int departmentid, int? appointmentid = default(int?), int? providerid = default(int?), string enddate = default(string), string startdate = default(string), bool? showallstatuses = default(bool?), bool? showalltypes = default(bool?), bool? showdiagnoses = default(bool?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{apivariant}/{practiceid}/chart/{patientId}/encounters").ToString();
            _url = _url.Replace("{practiceid}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(Practiceid, SerializationSettings).Trim('"')));
            _url = _url.Replace("{apivariant}", System.Uri.EscapeDataString(Apivariant));
            _url = _url.Replace("{patientId}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(patientId, SerializationSettings).Trim('"')));
            List<string> _queryParameters = new List<string>();
            ...
            {
                _queryParameters.Add(string.Format("appointmentid={0}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(appointmentid, SerializationSettings).Trim('"'))));
            }
            if (providerid != null)
            {
            ...
            // Create Result
            var _result = new HttpOperationResponse<IList<EncountersList>>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<IList<EncountersList>>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<IList<EncounterAssesmentText>>> GetEncounterAssesmentTextWithHttpMessagesAsync(int encounterid, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Apivariant == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Apivariant");
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("encounterid", encounterid);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "GetEncounterAssesmentText", tracingParameters);
            }
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            ...
            // Create Result
            var _result = new HttpOperationResponse<IList<EncounterAssesmentText>>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<IList<EncounterAssesmentText>>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse> AddEncounterAssesmentTextWithHttpMessagesAsync(string assessmenttext, int encounterid, bool? replacetext = default(bool?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                _invocationId = ServiceClientTracing.NextInvocationId.ToString();
                Dictionary<string, object> tracingParameters = new Dictionary<string, object>();
                tracingParameters.Add("assessmenttext", assessmenttext);
                tracingParameters.Add("replacetext", replacetext);
                tracingParameters.Add("encounterid", encounterid);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "AddEncounterAssesmentText", tracingParameters);
            }
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{apivariant}/{practiceid}/chart/encounter/{encounterid}/assesment").ToString();
            ...
            string _requestContent = null;
            var values = new List<KeyValuePair<string, string>>();
            values.Add(new KeyValuePair<string,string>("assessmenttext", assessmenttext));
            if(replacetext != null)
            {
                values.Add(new KeyValuePair<string,string>("replacetext", replacetext?.ToString()));
            }
            var _formContent = new FormUrlEncodedContent(values);
            _httpRequest.Content = _formContent;
            // Send Request
        ...
        public async Task<HttpOperationResponse<IList<EncounterDiagnosesList>>> GetPatientEncounterOrdersWithHttpMessagesAsync(int encounterid, bool? allowdischargetype = default(bool?), bool? showclinicalprovider = default(bool?), bool? showdeclinedorders = default(bool?), bool? showexternalcodes = default(bool?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                Dictionary<string, object> tracingParameters = new Dictionary<string, object>();
                tracingParameters.Add("encounterid", encounterid);
                tracingParameters.Add("allowdischargetype", allowdischargetype);
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{apivariant}/{practiceid}/chart/encounter/{encounterid}/orders").ToString();
            _url = _url.Replace("{practiceid}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(Practiceid, SerializationSettings).Trim('"')));
            _url = _url.Replace("{apivariant}", System.Uri.EscapeDataString(Apivariant));
            _url = _url.Replace("{encounterid}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(encounterid, SerializationSettings).Trim('"')));
            List<string> _queryParameters = new List<string>();
            if (allowdischargetype != null)
            {
                _queryParameters.Add(string.Format("allowdischargetype={0}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(allowdischargetype, SerializationSettings).Trim('"'))));
            }
            if (showclinicalprovider != null)
            {
                _queryParameters.Add(string.Format("showclinicalprovider={0}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(showclinicalprovider, SerializationSettings).Trim('"'))));
            }
            if (showdeclinedorders != null)
            {
                _queryParameters.Add(string.Format("showdeclinedorders={0}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(showdeclinedorders, SerializationSettings).Trim('"'))));
            }
            ...
            // Create Result
            var _result = new HttpOperationResponse<IList<EncounterDiagnosesList>>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<IList<EncounterDiagnosesList>>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        public async Task<HttpOperationResponse<ClaimsList>> GetClaimsWithHttpMessagesAsync(int? appointmentid = default(int?), int? providerid = default(int?), int? departmentid = default(int?), string createdenddate = default(string), string createdstartdate = default(string), int? patientid = default(int?), string procedurecodes = default(string), string serviceenddate = default(string), string servicestartdate = default(string), bool? showcustomfields = default(bool?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("providerid", providerid);
                tracingParameters.Add("departmentid", departmentid);
                tracingParameters.Add("createdenddate", createdenddate);
                tracingParameters.Add("createdstartdate", createdstartdate);
                tracingParameters.Add("patientid", patientid);
                tracingParameters.Add("procedurecodes", procedurecodes);
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "{apivariant}/{practiceid}/claims").ToString();
            _url = _url.Replace("{practiceid}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(Practiceid, SerializationSettings).Trim('"')));
            _url = _url.Replace("{apivariant}", System.Uri.EscapeDataString(Apivariant));
            List<string> _queryParameters = new List<string>();
            if (appointmentid != null)
            ...
            {
                _queryParameters.Add(string.Format("createdenddate={0}", System.Uri.EscapeDataString(createdenddate)));
            }
            if (createdstartdate != null)
            {
                _queryParameters.Add(string.Format("createdstartdate={0}", System.Uri.EscapeDataString(createdstartdate)));
            }
            if (patientid != null)
            {
                _queryParameters.Add(string.Format("patientid={0}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(patientid, SerializationSettings).Trim('"'))));
            ...
            {
                _queryParameters.Add(string.Format("procedurecodes={0}", System.Uri.EscapeDataString(procedurecodes)));
            }
            if (serviceenddate != null)
            {
                _queryParameters.Add(string.Format("serviceenddate={0}", System.Uri.EscapeDataString(serviceenddate)));
            }
            if (servicestartdate != null)
            {
                _queryParameters.Add(string.Format("servicestartdate={0}", System.Uri.EscapeDataString(servicestartdate)));
            }
            if (showcustomfields != null)
            {
                _queryParameters.Add(string.Format("showcustomfields={0}", System.Uri.EscapeDataString(SafeJsonConvert.SerializeObject(showcustomfields, SerializationSettings).Trim('"'))));
            ...
            // Create Result
            var _result = new HttpOperationResponse<ClaimsList>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<ClaimsList>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
