...
namespace AndriiKurdiumov.AuthenaHealth.Client
{
    ...
    public partial interface IAthenaHealth : System.IDisposable
    {
        ...
        /// multiple financial groups (also called "provider groups"), this
        /// will ensure you are retrieving the correct patient and not a copy
        /// that is in a different department.
        /// </param>
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<PatientLabResultDocumentList>> GetPatientLabResultDocumentsWithHttpMessagesAsync(int patientId, int? departmentid = default(int?), string documentsubclass = default(string), int? encounterid = default(int?), bool? showdeleted = default(bool?), bool? showtemplate = default(bool?), string status = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The file contents that will be attached to this document. Currently
        /// PDFs and PNGs are supported. PNG files must be Base64 encoded.
        /// </param>
        /// <param name='attachmenttype'>
        /// The file type of the attachment. Currently PDFs and PNGs are
        /// supported. Defaults to PDF.
        /// </param>
        /// <param name='autoclose'>
        /// Documents will, normally, automatically appear in the clinical
        /// inbox for providers to review.  In some cases, you might want to
        /// force the document to skip the clinical inbox, and go directly to
        /// the patient chart with a "closed" status. For that case, set this
        /// to true.
        /// </param>
        /// <param name='departmentid'>
        ...
        /// An internal note for the provider or staff. Updating this will
        /// append to any previous notes.
        /// </param>
        /// <param name='interpretation'>
        /// The practice entered interpretation of this result. Updating this
        /// will append to any previous values.
        /// </param>
        ...
        /// </param>
        /// <param name='departmentid'>
        /// The athenaNet department ID. Multiple IDs (either as a comma
        /// delimited list or multiple POSTed values) are allowed.
        /// </param>
        /// <param name='enddate'>
        /// End of the appointment search date range (mm/dd/yyyy). Inclusive.
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<LabResultList>> GetPatientLabResultsWithHttpMessagesAsync(int patientId, int departmentid, int? allresultsbyencounterid = default(int?), string analyteresultstatus = default(string), string enddate = default(string), string labresultstatus = default(string), bool? showabnormaldetails = default(bool?), bool? showhidden = default(bool?), bool? showtemplate = default(bool?), string startdate = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// each problem.  Also fills the bestmatchicd10code field with the
        /// best conversion from the problem SNOMED  code to ICD10 code if
        /// there is no user-selected ICD10 code in an encounter diagnosis
        /// event. Please note that the bestmatchicd10code may not always be
        /// accurate.
        /// </param>
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<ProceduresList>> GetPatientSurgicalHistoryWithHttpMessagesAsync(int patientId, int departmentid, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
